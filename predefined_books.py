...
CREATE TABLE predefined_books (
 ...
 PRIMARY KEY (first_peer_number, second_peer_number))""")
        ...
        print sys.argv[0], "DATABASE random PEDGE MINCYCLE MAXCYCLE MINBYTES MAXBYTES"
        print sys.argv[0], "traces/500peers.db random 0.1 999 9999 1024 90*pow(2,20)"
